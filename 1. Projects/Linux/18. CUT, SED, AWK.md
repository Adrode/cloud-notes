...
- Zasada użycia: po akcji wpisuje się nazwę zmiennej
	- **{action ZMIENNA}**
- Rodzaje zmiennych:
	- **NR** - numer rzędu pliku wyjściowego
		- np. **awk '{print NR}' plik.txt** - wyświetli wszystkie numery linii z pliku
	...
	- **ORS** - przechowuje separator linii, którym rozdzielane są linie na wyjściu

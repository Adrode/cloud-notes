...
#URI
- **URI (Uniform Resource Indentificator)** - identyfikuje zasób poprzez jego nazwę lub lokalizację
#URL 
- **URL (Uniform Resource Locator)** - identyfikuje zasób poprzez jego lokalizację; URL jest podzbiorem URI